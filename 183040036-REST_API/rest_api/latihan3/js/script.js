...
tampilkanSemuaMenu();
// Menampilkan daftar manu sesuai yang dipilih
    ...
    $.getJSON('data/pizza.json', function(data){
        ...
        $.each(menu, function(i, data){
            if(data.kategori == kategori.toLowerCase()){
                let isiMenu = '<div class="col-md-4"><div class="card mb-3"><img src="img/pizza/'+data.gambar+'" class="card-img-top"><div class="card-body"><h5 class="card-title">'+data.nama+'</h5><a href="#" class="btn btn-primary">Order!</a></div></div></div>';
